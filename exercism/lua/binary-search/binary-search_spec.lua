...
describe('binary-search', function()
  it('should return -1 when an empty array is searched #test1', function()
    local array = TracedArray{}

    assert.equal(-1, find(array, 6))
  end)

  it('should be able to find a value in a single element array with one access #test2', function()
  ...
  it('should return -1 if a value is less than the element in a single element array #test3', function()
  ...
  it('should return -1 if a value is greater than the element in a single element array #test4', function()
    local array = TracedArray{ 94 }
